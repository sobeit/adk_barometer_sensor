...
void loop()
{
  ...
  if(acc.isConnected()) {
    ...
    press = bmp085GetPressure(bmp085ReadUP());
    msg[0] = temp >> 8;
    msg[1] = temp & 0xff;
    msg[2] = (press & 0xff000000) >> 24;
    msg[3] = (press & 0x00ff0000) >> 16;
    msg[4] = (press &0x0000ff00) >> 8;
    msg[5] = press & 0x000000ff;
    acc.write(msg,6);
  } else {
  }
  delay(100);
